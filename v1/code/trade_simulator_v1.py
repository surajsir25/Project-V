...
# Load your data
df = pd.read_csv('/Users/surajkumar/Documents/codebases/alpha_research/Project-V/data/nifty_minute_data_with_ema.csv')
...
# Save to CSV
trades_df.to_csv('/Users/surajkumar/Documents/codebases/alpha_research/Project-V/data/ema_crossover_trades.csv', index=False)