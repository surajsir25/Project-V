...
trades_df = pd.read_csv('/Users/surajkumar/Documents/codebases/alpha_research/Project-V/v2/data/ema_crossover_trades.csv')
...
trades_df.to_csv('/Users/surajkumar/Documents/codebases/alpha_research/Project-V/v2/data/ema_crossover_trades_with_stats.csv', index=False)